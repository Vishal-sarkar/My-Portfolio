...
const HireMe = () => {
    return (
        <div className='fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 sm:right-0 md:left-auto md:top-0 md:bottom-auto md:absolute z-10'>
